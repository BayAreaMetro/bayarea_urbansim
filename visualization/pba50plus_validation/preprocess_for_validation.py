...
TAZDATA              = '.\TAZ1454 {} Land Use.csv'

COSTAR_2020_TAZ      = '.\costar_2020_taz1454.csv'
...
for year in BASE_YEARS:
    in_df = pd.read_csv(TAZDATA.format(year))
...
scenarios = {
    ...
    'v0: PBA50 equivalent inputs': {
        'path': Path(rf"C:\Users\{user}\Box\Modeling and Surveys\Urban Modeling\Bay Area UrbanSim\PBA50Plus_Development\Contingency\outputs\pba50_fbp_pr319_v0"),
        'pattern': 'taz1_summary_*'
    },
    'v1: BASIS buildings in dev pipeline': {
        'path': Path(rf"C:\Users\{user}\Box\Modeling and Surveys\Urban Modeling\Bay Area UrbanSim\PBA50Plus_Development\Contingency\outputs\pba50_fbp_pr319_v1"),
        'pattern': 'taz1_summary_*'
    },
    'v2: BASIS buildings, updated control totals': {
        'path': Path(rf"C:\Users\{user}\Box\Modeling and Surveys\Urban Modeling\Bay Area UrbanSim\PBA50Plus_Development\Contingency\outputs\pba50_fbp_pr319_v2"),
        'pattern': 'taz1_summary_*'
    },
    'v3: aligned 2020 HHINC control totals': {
        'path': Path(rf"C:\Users\{user}\Box\Modeling and Surveys\Urban Modeling\Bay Area UrbanSim\PBA50Plus_Development\Contingency\outputs\pba50_fbp_pr319_v3"),
        'pattern': '*_taz1_summary_*'
    },
    'v4: aligned 2020 HHINC+employment control totals': {
        'path': Path(rf"C:\Users\{user}\Box\Modeling and Surveys\Urban Modeling\Bay Area UrbanSim\PBA50Plus_Development\Contingency\outputs\pba50_fbp_pr319_v4"),
        'pattern': '*_taz1_summary_*'
    },
    'v4: aligned 2020 HHINC+employment control totals': {
        'path': Path(rf"C:\Users\{user}\Box\Modeling and Surveys\Urban Modeling\Bay Area UrbanSim\PBA50Plus_Development\Contingency\outputs\pba50_fbp_pr319_v4"),
    ...
    'v5: aligned control totals, updated pipeline': {
        'path': Path(rf"C:\Users\{user}\Box\Modeling and Surveys\Urban Modeling\Bay Area UrbanSim\PBA50Plus_Development\Contingency\outputs\pba50_fbp_pr319_v5"),
        'pattern': '*_taz1_summary_*'
    },
    'v6: additional pipline updates, costar data, fixed vacancy': {
        'path': Path(rf"C:\Users\{user}\Box\Modeling and Surveys\Urban Modeling\Bay Area UrbanSim\PBA50Plus_Development\Contingency\outputs\pba50_fbp_pr319_v5_a"),
        'pattern': '*_taz1_summary_*'
    },
    'v7: housing preservation activated in 2025': {
        'path': Path(rf"C:\Users\{user}\Box\Modeling and Surveys\Urban Modeling\Bay Area UrbanSim\PBA50Plus_Development\Contingency\outputs\pba50_fbp_pr319_v7_vac_plus_pipe"),
        'pattern': '*_taz1_summary_*'
    },
    'v8: run from main': {
        'path': Path(rf"C:\Users\{user}\Box\Modeling and Surveys\Urban Modeling\Bay Area UrbanSim\PBA50Plus_Development\Contingency Reassignment\outputs\contingency_v8"),
        'pattern': '*_taz1_summary_*'
    }
}
