...
def jobs_housing_ratio(county_summary_initial, county_summary_final, modelrun_id, model_run_alias, plan, output_path):
    """
    ...
    def calculate_ratio(df, year):
        ...
        df_grouped['modelrun_alias'] = f"{year} {model_run_alias}"
