...
@orca.step()
def slr_inundate(parcels, slr_progression, slr_parcel_inundation,
                 slr_parcel_inundation_mitigation, year):
    ...
    if policy['slr_mitigation']:
        slr_parcel_inundation = slr_parcel_inundation_mitigation.to_frame()
        orca.add_injectable("slr_mitigation", 'mitigation')
    else:
        slr_parcel_inundation = slr_parcel_inundation.to_frame()
        orca.add_injectable("slr_mitigation", 'no mitigation')
