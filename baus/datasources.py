...
def growth_geographies():
    return os.path.join(orca.get_injectable("inputs_dir"), "basis_inputs/crosswalks/growth_geographies_v0.csv")
...
@orca.table(cache=True)
def buildings():
    return os.path.join(orca.get_injectable("inputs_dir"), "basis_inputs/parcels_buildings_agents/buildings.csv")
